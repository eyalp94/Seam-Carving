...
//	private static BufferedImage markSeam(BufferedImage image,int[] path)
//	{
//		for (int i = 0 ; i < image.getHeight() ; i++){
//			image.setRGB(path[i], i, 125);
//		}
//		return image;
//	}
...
//				System.out.println(cnt);
	...
	{
		File file= new File("C:\\pic2.jpeg");
		BufferedImage image = ImageIO.read(file);
		
		for(int i=0; i<100; i++)
		{
			image = deleteStraightMinSeam(image, 1);
		...
		File outputFile = new File("D:\\picture1.bmp");
		ImageIO.write(image, "bmp", outputFile);
		
//		overall(args[0], Integer.parseInt(args[1]),Integer.parseInt(args[2]), Integer.parseInt(args[3]), args[4]);
	}
